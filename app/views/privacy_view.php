<main aria-label="Privacy Policy Section">
    ...
    <section id="privacy-section">
        ...
        <p>We use third-party services in various parts of our platform. Below are the websites and platforms we rely on:</p>
        <ul>
            <li><strong>Images:</strong> We use photos from <a href="https://www.pexels.com" target="_blank">Pexels</a> for some of the visual content on our website.</li>
            <li><strong>Logo:</strong> Our logo design is sourced from <a href="https://www.svgrepo.com" target="_blank">SVGRepo</a>, which provides high-quality vector logos.</li>
            <li><strong>Recipe Generation:</strong> Some of our recipe content and ideas are generated using <a href="https://chatgpt.com" target="_blank">ChatGPT</a>.</li>
        </ul>
        ...
        <ul>
            ...
            <li><strong>Right to Restriction of Processing:</strong> You can request that we restrict the processing of your personal data under specific circumstances.</li>
            <li><strong>Right to Data Portability:</strong> You can request that we transfer your personal data to another service provider.</li>
            <li><strong>Right to Object:</strong> You can object to the processing of your personal data under certain circumstances.</li>
        </ul>
        <p>If you would like to exercise any of these rights, please contact us at <a href="mailto:admin@example.com">admin@example.com</a>.</p>

        <h2>7. Security of Your Data</h2>
        <p>We take the security of your personal data seriously. We use a variety of security measures, including encryption, to protect your personal data from unauthorized access, alteration, or destruction.</p>

        <h2>8. Children’s Privacy</h2>
        <p>Our services are not intended for children under the age of 16. We do not knowingly collect or solicit personal data from children under 16. If we learn that we have collected personal data from a child under 16, we will delete that information as quickly as possible.</p>
